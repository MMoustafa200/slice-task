...
const quote_validation_1 = require("../validations/quote.validation");
...
router.get('/quote', quote_validation_1.quoteValidation.randomQuote, is_auth_middleware_1.isAuth, quoteController.getRandomQuote.bind(quoteController));
